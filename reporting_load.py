...
##Recreating a new loading fact template table like the original
sql1=text("CREATE TABLE hinge_loading.fact_ratings_new_template_2 (LIKE fact_ratings_new_template)")
sql2=text("DROP hinge_loading.fact_ratings_new_template")
sql3=text("ALTER TABLE hinge_loading.fact_ratings_new_template_2 RENAME TO act_ratings_new_template")
conn.execute(sql1.execution_options(autocommit=True))
conn.execute(sql2.execution_options(autocommit=True))
conn.execute(sql3.execution_options(autocommit=True))